...
function AppointmentBooking() {
  ...
  <div class="govuk-form-group">
    ...
    <textarea class="govuk-textarea govuk-input--width-20" id="appointment-notes" name="appointment-notes" rows="5"></textarea>
  </div>
  <button class="govuk-button" data-module="govuk-button" type="submit" onClick={handleSubmit}>
  Confirm and Book
</button>
</fieldset>
    </form>
