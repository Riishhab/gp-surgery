  ...
  return (
    <header className="govuk-header " role="banner" data-module="govuk-header">
      <div className="govuk-header__container govuk-width-container">
        ...
        <div className="govuk-header__content" style={{ width: "auto" }}>
          <Link
            to="/home"
          ...
          <nav aria-label="Menu" className="govuk-header__navigation ">
            ...
            <ul id="navigation" className="govuk-header__navigation-list">
              <li className="govuk-header__navigation-item govuk-header__navigation-item--active">
                <Link className="govuk-header__link" to="/home">
                  Home
                </Link>
              </li>
              ...
              <li className="govuk-header__navigation-item">
                <Link className="govuk-header__link" to="/booking">
                  Book Appointment
                </Link>
              </li>
              <li className="govuk-header__navigation-item">
                <Link className="govuk-header__link" to="/patient-appointment">
                  Manage Appointments
                </Link>
              </li>
              <li className="govuk-header__navigation-item">
              ...
              <li className="govuk-header__navigation-item">
                <Link className="govuk-header__link" to="/patient-profile">
                  Profile
                </Link>
              </li>
            </ul>
